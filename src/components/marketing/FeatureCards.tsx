...
const FEATURES = [
  ...
  },
  {
    ...
    body: "Where available, our system checks ABN/business-registration details against the Australian Business Register automatically — result in seconds. This is not a licence, insurance, quality or general-compliance guarantee.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="h-7 w-7" aria-hidden>
